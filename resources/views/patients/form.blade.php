{!! Form::open(['route' => $route, 'method' => $method, 'class' => 'form']) !!}
	...
	<div class="form-group">
		...
		{!! Form::text('document', $patient->document, ['class' => 'form-control']) !!}
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		{!! Form::text('civil_status', $patient->civil_status , ['class' => 'form-control']) !!}
	</div>
	<div class="form-group">
		{!! Form::label('gender', 'Genero') !!}
		{!! Form::text('gender', $patient->gender, ['class' => 'form-control']) !!}
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		{!! Form::text('degree_of_instruction', $patient->degree_of_instruction, ['class' => 'form-control']) !!}
	</div>
